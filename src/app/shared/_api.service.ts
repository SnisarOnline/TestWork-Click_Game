...
export class ApiService {
  ...
  gameSettings(): Observable<any> {
    return this.httpClient.get( env.apiBaseUrl + 'game-settings', this.httpOptions)
    .pipe(
  ...
  gameWinners(): any {
    return this.httpClient
      .get( env.apiBaseUrl + 'winners', this.httpOptions)
      .pipe(
  ...
  sentResult(post: WinnerModel) {
    return this.httpClient
      .post( env.apiBaseUrl + 'winners', post,  this.httpOptions)
